...
export type Order = Node & {
   ...
   * ProductVariants nor discounts resulting from applied Promotions. For location,
...
export namespace CreateLocation {
  export type Variables = CreateLocationMutationVariables;
  export type Mutation = CreateLocationMutation;
  export type CreateLocation = (NonNullable<CreateLocationMutation['createLocation']>);
}

export namespace UpdateLocation {
  export type Variables = UpdateLocationMutationVariables;
  export type Mutation = UpdateLocationMutation;
  export type UpdateLocation = (NonNullable<UpdateLocationMutation['updateLocation']>);
}
